<template>
   <section class="flex items-center justify-center flex-col mt-16 herocontainer" id="home">
  ...
  <ph-download-simple :size="25" /><a href="https://drive.google.com/file/d/1j3XnAP2PJPzQRe0MZ6H_a6nU6UToiyT9/view?usp=sharing" target="_blank" rel="noopener noreferrer" class="linkDownload">English resume</a>
</button>
  ...
  <a href="https://github.com/Evelyn-Nobile" target="_blank" rel="noopener noreferrer" class="linkGithub">Visit my Github</a>
        ...
        <div class="mt-6 flex justify-center items-center ">
               <a href="https://drive.google.com/file/d/1PQc8oqtPnv-vItebLSh_78jLDrhpz_9M/view?usp=sharing" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 linkcv "><ph-download-simple :size="22" /> Descarga mi cv en español</a>
            </div>
...
<script setup>
import { PhDownloadSimple, PhGithubLogo } from '@phosphor-icons/vue'
</script> 
